...
- **Create a PyCharm project with a .git and .venv:**
    - Open PyCharm and create a new project. You can specify the location of the project folder.
    - Inside your project, initialize a Git repository: `.git`
    - Create a virtual environment inside the project: `.venv` directory.
...
- **Create the helpers_serialize.py file:**
    ...
    - Create an empty __init__.py file in the helpers directory

- **Create the setup.py file:**
    - Add version, install_requires and packages informations inside.
